 ...
 */
public class FoodAdapter1 extends BaseAdapter implements AbsListView.OnScrollListener{
    ...
    public FoodAdapter1(List<foodModel> models, Context context, int firstnum, String[] urls, ListView listView) {
        this.data = models;
