...
public class RunAdapter extends BaseAdapter implements AbsListView.OnScrollListener{
    ...
    public RunAdapter(List<runModel> data, Context mContext, int firstnum, String [] urls, ListView listView) {
