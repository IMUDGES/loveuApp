...
public class GiveMainListAdapter extends BaseAdapter{
    ...
    public GiveMainListAdapter( Context mContext,List<giveModel> giveModels,List<userModel> userModels) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        viewHolder.name.setText(giveModels.get(i).getGiveId());
        ...
        if(viewHolder.bitmap!=null){
            ...
            new photoAsyncTask(viewHolder.imageView,viewHolder).execute(userModels.get(i).getUserPhoto());
        }
        return null;
    }
