package com.example.loveuApp.homepage.xue.adapter;
...
public class XueMainListAdapter extends BaseAdapter implements AbsListView.OnScrollListener{
    ...
    public XueMainListAdapter(List<xueModel> data, Context mContext, PullToRefreshListView listView, String [] urls) {
        this.data = data;
